...
export default function ProductClient({ product, dict, lang }: { product: any, dict: any, lang?: string }) {
  ...
  const madeToOrderText = dict?.made_to_order_takes || "Made to Order";
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12 md:py-20 grid grid-cols-1 md:grid-cols-2 gap-12">
      ...
      <div className="flex flex-col justify-center">
        ...
        <div className="mt-10">
          <h3 className="text-sm font-bold text-custom-charcoal mb-4 uppercase tracking-wider">{dict?.order_via || "Order via:"}</h3>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <a 
              href={`https://m.me/todor.petrov?text=${messageText}`}
              target="_blank"
