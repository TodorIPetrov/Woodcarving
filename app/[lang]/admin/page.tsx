    ...
    <AdminAuth>
      <div className="max-w-7xl mx-auto px-4 py-12 md:py-20">
        <div className="flex justify-between items-end mb-8 border-b border-gray-200 pb-4">
          <div>
            <h1 className="font-serif text-3xl md:text-5xl text-custom-forest font-bold mb-2">Admin Dashboard</h1>
            <p className="text-custom-charcoal/80">Manage your store's orders and products.</p>
          </div>
        ...
        <AdminTabs ordersContent={ordersContent} />
      </div>
    </AdminAuth>
  );
}
